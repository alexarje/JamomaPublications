...
The \textbf{Graphics Layer}\footnote{\url{http://github.com/tap/JamomaGraphics}},based on Cairo\footnote{\url{http://cairographics.org}}, provides both a platform-independent, and a host-independent, way to draw to the screen.  While not necessarily related to audio or DSP it is relevant in that GUI widgets can be created that will work, for example, both in the Max/MSP environment and in an AudioUnit plug-in.

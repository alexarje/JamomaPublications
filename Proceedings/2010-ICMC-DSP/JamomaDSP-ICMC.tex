...
% TODO: change name to 64-bit or some other criteria rather than the framework name
...
\subsubsection{Dynamic Something?}

% TODO: Tim -- do this:

%TODO: come out and actually say this is implementing the reflective/dynamic-binding/polymorphic stuff from the abstract [tap]  e.g. Quoting Tim: All attribute setters use the same interface (prototype) regardless of the type of data.

% talk about how this relates to other parts of the system, e.g. observers

% Introduce TTValue / polymorphic concepts here too (required for Message and Attr interfaces)

...
% TODO: can we make this screenshot bigger?
...
% potential for rapid prototyping - and DRY stuff - % boring stuff taken care of -- clean code -DONE
% expand wrappers to more environments - DONE
...
% Scheduler - do we need to include this in the discussion? - DONE
% user-extensible (at runtime) -- so it can be expanded even more - DONE
...
% TODO DO we manage to phrase the following a bit more clearly?
% Exploring implicit patching paradigms - also for dynamic rerouting between modules

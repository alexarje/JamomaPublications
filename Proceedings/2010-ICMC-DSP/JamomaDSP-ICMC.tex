...
The Jamoma Foundation classes are informed by many best-practices of software development.   This includes use of design patterns\cite{Gamma:1995}.  In particular, all objects possess a built-in observer notification system.
...
Additional layers have been implemented on top of the Jamoma Foundation, but in series and in parallel with the DSP layer.

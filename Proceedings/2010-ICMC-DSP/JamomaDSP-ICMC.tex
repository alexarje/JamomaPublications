...
\threeaffiliations{\paperauthorA}{74 Objects LLC \\ {\tt \href{mailto:tim@74objects.com}{tim@74objects.com}}}
  {\paperauthorB}{BEK \\ {\tt \href{trond.lossius@bek.no}{trond.lossius@bek.no}}}
  {\paperauthorC}{McGill University, CIRMMT \\ {\tt \href{mailto:nils.peters@mcgill.ca }{nils.peters@mcgill.ca }}}
...
\begin{figure}[htbp]
\centerline{\framebox{
	\includegraphics[width=0.9\columnwidth]{layers-alt2}}}
...
% TODO: Tim -- inconsistent capitalization of irb throughout, including the following section title
...
% TODO: this breaks across paragraphs -- yuck
...
% What we left out in the above paragraph is that we can combine objects in these environments to find something desireable and then back-port what we find into C++.
...
The GNU LGPL license chosen for the Jamoma frameworks have enabled them to be used for open-source as well as commercial software development.  Electrotap's Tap.Tools \cite{web17} is a collection of externals for Max/MSP with an emphasis on audio effects processing.  Hipno \cite{web18} was a set of audio effects plug-ins in the VST, RTAS and AudioUnit formats using the now discontinued Cycling'74 Pluggo environment.  Plug-in development expanding upon the ideas from Hipno is underway, using the Jamoma Platform as a means of gaining independence from the restrictions of proprietary frameworks.
...
\bibitem[A12]{web12}  \url{http://github.com/tap/JamomaAudioGraph}
...
\bibitem[A18]{web18}   \url{http://74objects.com/hipno} 
\end{thebibliography} 

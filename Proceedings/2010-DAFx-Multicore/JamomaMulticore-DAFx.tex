...
Alternatively, the Jamoma Platform implements a clear separation of concerns, structured in a layered architecture of several frameworks \cite{Place:2010}.
 ...
 Jamoma Multicore, the focus of in this paper, is an open source C++ framework providing the ability to create and network Jamoma DSP objects into dynamic graph structures for audio processing\footnote{Licensing is provided under the terms of the GNU LGPL}.  
...
An additional design difference between Jamoma Multicore and most other audio processing graph software is the use of a peer object model.  
...
In Csound multichannel audio graphing is extended somewhat through the introduction of the Zak Patch System and the "chn" set of opcodes.
...
Figure \ref{fig:max-before-after}(a) shows the signal processing patch of the Jamoma module for spatializing incomming sounds using Vector Base Amplitude Panning (VBAP) \cite{Pulkki:1997vbap}. 

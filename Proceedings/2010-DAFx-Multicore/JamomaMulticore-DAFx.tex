...
% TODO: The following is not computational performance! The heading of simply using 'Performance' for this section was much better.  It's better to be ambiguous than wrong ;-) [TAP]

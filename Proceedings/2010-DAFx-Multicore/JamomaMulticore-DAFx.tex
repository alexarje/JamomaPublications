...
% TODO: not sure how boastful we really want to be with the above -- testing and documentation are currently anemic (at best).  [TAP]
...
% TODO: Is multithreading just a part of performance rather than it's own subsubsection? [TAP]
...
% TODO: Not sure this "Future Work" section should be separate.  Most of the previous section is also Future Work that doesn't really exist yet...

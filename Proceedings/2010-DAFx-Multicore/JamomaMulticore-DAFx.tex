...
In order to meet the stated requirements, the Jamoma audio graph layer relies on a \emph{pull} pattern (see Section XYZ TODO: ) and is designed to be independent from the host environment's DSP scheduler as much as possible.

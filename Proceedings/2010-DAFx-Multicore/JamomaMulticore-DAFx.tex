...
% (end)
%TODO: the picture should be renewed, showing Jamoma Audio Graph instead of Multicore
...
Here, we are planning to explore the potential to attach additional meta-information to the individual audio channels to ensure that audio material is correctly processed (e.g. to identify the signals in an Ambisonics B-format, or to distinguish a binaurally processed audio stream from a conventional stereo track). 

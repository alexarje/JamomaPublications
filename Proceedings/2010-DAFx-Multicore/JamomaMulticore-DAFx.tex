...
Explain the graph description and how it can be used to generate a visual representation, or even source code, to express the graph's structure.
...
A potential solution to this problem (as stated by Gino Robair): "Because in 15 years, I will still be using my hardware synths and effects, but I can guarantee that every bit of software I'm using today‚ along with its sessions, patches, and stored settings‚ will be inaccessible, either through lack of developer support, because the host computer has died, or because subsequent upgrades no longer open the files I created with today's version."

...
- interfacing with MSP: jcom.pack$\approx$ and jcom.unpack$\approx$

- splice and slice: jcom.join$\approx$, jcom.split$\approx$

- audio in/out using PortAudio: jcom.adc$\approx$  and jcom.dac$\approx$ (do we need reference for PortAudio?)

- audio generators: jcom.noise$\approx$, jcom.phasor$\approx$, jcom.wavetable$\approx$

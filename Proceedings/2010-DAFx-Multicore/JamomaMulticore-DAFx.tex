...
Ruby offers a wealth of application areas include web development using Ruby On Rails\footnote{http://rubyonrails.org} and Live Coding\cite{Collins:2003} using \emph{irb}.  
...
% CHANGED: Trond trying to create a general outline for this part

\subsection{Efficiency}

\subsubsection{Pleasant code design}

\subsubsection{Patch development efficiency}
...
\subsubsection{Multiple Simultaneus Graphs}

\subsubsection{Dynamic vector size}

\subsection{Future work}

\subsubsection{Mighty Mixer}
